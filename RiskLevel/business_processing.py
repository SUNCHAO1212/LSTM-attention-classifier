...
# 分词
jieba.load_userdict('risklevel/userfiles/dict_catalog.txt')
jieba.load_userdict('risklevel/userfiles/dict_entity1.txt')
jieba.load_userdict('risklevel/userfiles/dict_pinpai.txt')
...
pattern = re_pattern('risklevel/risk_abc/re')
re_A = re_pattern('risklevel/risk_abc/A')
re_B = re_pattern('risklevel/risk_abc/B')
re_C = re_pattern('risklevel/risk_abc/C')
punctuation = ['!', '?', '？', '！', '，', '。']


def chinese_risk_level(title, content, label):
    if label == '不需要':
        return '无'
...
with codecs.open('risklevel/userfiles/attention_words_filtered', 'rb', 'utf8') as f:
